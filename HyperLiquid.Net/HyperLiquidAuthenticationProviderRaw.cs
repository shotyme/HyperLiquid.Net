...
using HyperLiquid.Net.MiniMessagePack;

namespace HyperLiquid.Net
{
    internal class HyperLiquidAuthenticationProviderRaw : AuthenticationProvider
    {
        public HyperLiquidAuthenticationProviderRaw(ApiCredentials credentials) : base(credentials)
        {
        }
